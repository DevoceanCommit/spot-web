...
const Chat = () => {
  ...
  const predefinedResponses = [
    ...
    { text: "그래 안 깨고 푹 잤다", sender: "me" },
    {
      text: "잘 주무셨다니 다행이네요. 요즘 기분은 어떠세요? 우울하거나 기분이 안 좋지는 않으세요?",
      sender: "other",
    },
    { text: "요즘 집에 혼자 있는 시간이 많아서 우울하네", sender: "me" },
    { text: "어디 다녀오시는 건 어떠세요?", sender: "other" },
    { text: "좋다, 잠깐 산책이라도 다녀오마.", sender: "me" },
    {
      text: "좋은 선택이세요! 산책하면서 기분 전환 잘 하시고, 따뜻하게 입고 나가세요!",
      sender: "other",
    },
    {
      text: "고마워, 다녀와서 기분이 나아지면 좋겠다.",
      sender: "me",
    },
    {
      text: "네, 기분이 조금이라도 나아지길 바랍니다. 다녀와서 이야기 나누고 싶으면 언제든 말씀해주세요! \n 대화가 종료되었습니다",
      sender: "other",
    },
  ];
